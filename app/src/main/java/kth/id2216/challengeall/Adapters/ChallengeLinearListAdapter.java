...
public class ChallengeLinearListAdapter extends FirebaseListFilteredAdapter<Challenge> {
    ...
    public ChallengeLinearListAdapter(final Firebase ref, final AppCompatActivity activity, int listType, Map<String,Object> filter) {
